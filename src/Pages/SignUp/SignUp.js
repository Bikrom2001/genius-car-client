      ...
      <div className="hero-content grid gap-10 md:grid-cols-2  flex-col lg:flex-row">
        ...
        <div className="card  w-full  shadow-2xl bg-base-100">
          ...
          <div className='px-8 pb-8 mt-0'>
            ...
            <p className="text-xs text-center sm:px-6 dark:text-black">allready have an account?
              <Link rel="noopener noreferrer" to='/login' className="underline dark:text-orange-600"> Login</Link>
            </p>
